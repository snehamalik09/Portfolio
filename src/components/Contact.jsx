        ...
        <div name="Contact">
            <div className='w-3/4 lg:w-3/4 lg:pt-20 lg:pb-28 px-18 py-12 h-full md:mt-[18%]  flex flex-col justify-center  items-center mx-auto gap-12 border-4 border-black rounded-xl text-black'>
                ...
                <form action="https://getform.io/f/lajnnpoa" method="POST" className = "flex flex-col h-full gap-3 w-3/4 lg:w-1/2 md:w-2/3">
                        <input type="text" placeholder="Name" className=' p-2 bg-white border-black border-[3px] required' />
                        <input type="email" placeholder="Email" className='p-2 bg-white border-[3px] border-black required' />
                        <input type="text" placeholder="Subject" className='p-2 bg-white border-[3px] border-black' />
                ...
                <a href={resume} download={true} className='bg-blue-800 mx-auto font-bold my-[5%] p-2 lg:w-1/6 rounded-md border-2 text-center hover:bg-white hover:text-blue-800 hover:border-blue-800 hover:font-semibold duration-500'> Download Resume </a>
                </div>
        </div>
    )
}
